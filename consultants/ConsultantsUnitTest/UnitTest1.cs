...
namespace ConsultantsUnitTest
{
    ...
    public class UnitTest1
    {
        ...
        public void GetAssignments_ShouldReturnAllAssignments()
        {
            ...
            context.Details.Add(new Details { Assignment_ID = 2, Assignment_Name = "Website", Client_Name = "Telia", Percentage = "80%", Start_Date = DateTime.Parse("2016-07-21"), End_Date = DateTime.Parse("2017-03-31"), Comment = "Website for Telia",Consultant_Name="fayek" });
